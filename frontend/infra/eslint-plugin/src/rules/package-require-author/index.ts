...
export const requireAuthorRule: Rule.RuleModule = {
  meta: {
    ...
    messages: {
      requireAuthor:
        'package.json 文件必須提供 author 字段，這有助於正確生成 CODEOWNER 文件，幫助正確指定代碼 reviewer',
      authorShouldBeBytedancer:
        // cp-disable-next-line
        'package.json 文件的 author 字段值應該爲 `@bytedance.com` 結尾的郵箱名',
      maintainerShouldBeBytedancers:
        // cp-disable-next-line
        'package.json 文件的 maintainers 字段值應該爲 `@bytedance.com` 結尾的郵箱名數組',
    },
  },
