  ...
  const options: Option[] = [
    {
      ...
      label: I18n.t('workflow_250407_208', undefined, '中斷流程'),
      tooltip: I18n.t(
        'workflow_250407_209',
        undefined,
        '發生異常後，中斷流程執行。異常信息將會顯示在節點卡片上，或者通過調用結果返回。',
      ),
    },
    {
      value: SettingOnErrorProcessType.RETURN,
      label: I18n.t('workflow_250407_210', undefined, '返回設定內容'),
      tooltip: I18n.t(
        'workflow_250407_211',
        undefined,
        '發生異常後，流程不會中斷。異常信息會通過isSuccess、errorBody返回。開發者可設定需要返回的內容。',
      ),
    },
    ...(isBatch
      ? []
      : [
          {
            ...
            label: I18n.t('workflow_250407_212', undefined, '執行異常流程'),
            tooltip: I18n.t(
              'workflow_250407_213',
              undefined,
              '發生異常後，流程不會中斷。異常信息會通過isSuccess、errorBody返回，同時會新增異常分支。開發者需要完善異常處理流程後，方可運行流程。',
            ),
          },
        ]),
  ];
