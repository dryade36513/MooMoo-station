...
export function QuestionPairs() {
  ...
  return (
    <>
      <Field
        label={I18n.t('workflow_ques_content', {}, '提問內容')}
      ...
      <Field label={I18n.t('workflow_240919_02', {}, '問答類型')}>
        <div className={styles.question_pairs_content}>
          {isOptions
            ? I18n.t('workflow_ques_ans_type_option', {}, '選項回答')
        ...
        <>
          ...
          <Field label={''}>
            <AnswerItem
              ...
              content={I18n.t('workflow_240919_03', {}, '用戶不可見')}
            />
