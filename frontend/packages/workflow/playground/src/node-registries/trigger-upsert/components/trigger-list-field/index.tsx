...
export const TriggerListField = withField<TriggerListProps>(
  ({ bindWorkflowId }) => {
    ...
    const columns = [
      ...
      {
        title: I18n.t('workflow_trigger_user_create_name', {}, '名稱'),
        dataIndex: 'triggerName',
        render: d => `${d}`,
      },
      {
        title: I18n.t('workflow_trigger_user_create_time', {}, '創建時間'),
        dataIndex: 'createTime',
        render: d => `${d}`,
      },
      {
        title: I18n.t('workflow_trigger_user_create_schedula', {}, '觸發時間'),
      ...
      {
        title: I18n.t('workflow_trigger_user_create_userid', {}, '用戶id'),
        dataIndex: 'useId',
        render: d => `${d}`,
      },
      {
      ...
      <div className="!p-0">
        <div className="">
          <IconNameDescCard
            ...
            name={I18n.t('workflow_trigger_user_create_list', {}, '觸發器列表')}
            description={I18n.t(
        ...
        <Modal
          title={I18n.t('workflow_trigger_user_create_list', {}, '觸發器列表')}
          width={'80%'}
          visible={visible}
          onCancel={() => {
            setVisible(false);
          ...
          footer={
            <div className="flex flex-row gap-[8px] justify-end">
              <Button
                ...
                loading={loading}
              >
                {I18n.t('workflow_trigger_user_create_close', {}, '關閉')}
              </Button>
              <Button
                icon={<IconCozRefresh />}
                color="primary"
