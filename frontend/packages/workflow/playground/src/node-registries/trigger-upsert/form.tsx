...
export const FormRender = withNodeConfigForm(value => {
  ...
  return (
    <>
      ...
      <Section title={I18n.t('workflow_detail_node_input', {}, '輸入')}>
            ...
            fieldConfig={[
              {
                description: I18n.t(
                  ...
                  {},
                  '觸發器的唯一標識，若填寫已存在id觸發器列表中則爲更新觸發器信息。',
                ),
                name: 'triggerId',
              ...
              },
              {
                ...
                description: I18n.t(
                  ...
                  {},
                  '用於設置觸發器所屬用戶，可以使用變量-系統變量中的sys_uuid來唯一標識用戶',
                ),
                name: 'userId',
                required: true,
                type: ViewVariableType.String,
              ...
              {
                label: I18n.t('workflow_trigger_user_create_name', {}, '名稱'),
                description: I18n.t(
