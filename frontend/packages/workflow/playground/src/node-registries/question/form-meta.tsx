...
export const QUESTION_FORM_META: FormMetaV2<FormData> = {
  ...
  validate: {
    ...
    [questionFieldName]: ({ value }) =>
      value
        ? undefined
        : I18n.t('workflow_detail_node_error_empty', {}, '參數值不可爲空'),
