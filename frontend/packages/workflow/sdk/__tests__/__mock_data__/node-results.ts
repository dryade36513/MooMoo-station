...
export const mockNodeResults = [
  {
    ...
    extra: '',
    input: '{"input":"世界上有多少個國家？","timeout":2000}',
    logVersion: 1,
    needAsync: false,
    nodeExeCost: '0.000s',
    nodeId: '100001',
    nodeStatus: 3,
    output: '{"input":"世界上有多少個國家？","timeout":2000}',
    raw_output: '{"input":"世界上有多少個國家？","timeout":2000}',
  },
  {
    NodeName: '結束',
    NodeType: 'End',
    ...
    input:
      '{"output":"截至2024年7月，世界上共有233個國家和地區，其中國家有197個（主權國家195個），地區有36個。\\n\\n聯合國會員國目前有193個，此外梵蒂岡是聯合國觀察員國，巴勒斯坦是聯合國觀察員實體，這兩個在國際上也被廣泛承認爲國家。 "}',
    logVersion: 1,
    needAsync: false,
    nodeExeCost: '0.000s',
    nodeId: '900001',
  ...
  },
  {
    ...
    nodeStatus: 3,
    output:
      '{"key0":"請回答問題：世界上有多少個國家？","key1":["hello","world"],"key2":{"key21":"hi"}}',
    raw_output:
      '{"key0":"請回答問題：世界上有多少個國家？","key1":["hello","world"],"key2":{"key21":"hi"}}',
    tokenAndCost: {},
  },
  {
    ...
    output:
      '{"output":"截至2024年7月，世界上共有233個國家和地區，其中國家有197個（主權國家195個），地區有36個。\\n\\n聯合國會員國目前有193個，此外梵蒂岡是聯合國觀察員國，巴勒斯坦是聯合國觀察員實體，這兩個在國際上也被廣泛承認爲國家。 "}',
    raw_output:
      '截至2024年7月，世界上共有233個國家和地區，其中國家有197個（主權國家195個），地區有36個。\n\n聯合國會員國目前有193個，此外梵蒂岡是聯合國觀察員國，巴勒斯坦是聯合國觀察員實體，這兩個在國際上也被廣泛承認爲國家。 ',
    tokenAndCost: {
      inputCost: '$0.00',
