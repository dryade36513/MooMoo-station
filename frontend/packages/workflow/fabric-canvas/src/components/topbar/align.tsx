    ...
    >
      ...
      >
        <Select.OptGroup label="a">
          {[
            {
              name: I18n.t('imageflow_canvas_align1', {}, '左對齊'),
            ...
            {
              name: I18n.t('imageflow_canvas_align3', {}, '右對齊'),
        ...
        <Select.OptGroup label="b">
          {[
            {
              name: I18n.t('imageflow_canvas_align4', {}, '頂部對齊'),
              value: AlignMode.Top,
            ...
            {
              name: I18n.t('imageflow_canvas_align6', {}, '底部對齊'),
