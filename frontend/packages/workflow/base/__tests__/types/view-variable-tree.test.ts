...
describe('view-variable-tree', () => {
  describe('ViewVariableTreeNode 類型', () => {
    it('應該能夠創建基本的變量樹節點', () => {
  ...
  describe('ViewVariableMeta 類型', () => {
    ...
    it('應該繼承 ViewVariableTreeNode 的所有屬性', () => {
      const meta: ViewVariableMeta = {
        key: 'test',
        type: ViewVariableType.String,
        name: 'Test Meta',
  ...
  describe('ViewVariableTreeNode 命名空間函數', () => {
