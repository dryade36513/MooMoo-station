    ...
    },
    {
      ...
      data: {
        nodeMeta: {
          ...
          description:
            '在選定的知識中,根據輸入變量召回最匹配的信息,並以列表形式返回',
          subTitle: '知識庫',
        },
        outputs: [
          {
    ...
    },
    {
      ...
      data: {
        nodeMeta: {
          ...
          description:
            '連接兩個下游分支，如果設定的條件成立則只運行“如果”分支，不成立則只運行“否則”分支',
          subTitle: '選擇器',
        },
        inputs: {
          branches: [
    ...
    },
    {
      ...
      data: {
        nodeMeta: {
          ...
          description:
            '用於讀取和寫入機器人中的變量。變量名稱必須與機器人中的變量名稱相匹配。',
          subTitle: '變量',
        },
        inputs: {
          mode: 'set',
      ...
      blocks: [
        {
          ...
          data: {
            ...
            nodeMeta: {
              ...
              description: '用於重置循環變量的值，使其下次循環使用重置後的值',
              subTitle: '設置變量',
            },
          },
        },
        {
          ...
          data: {
            nodeMeta: {
              ...
              description: '支持中間過程的消息輸出，支持流式和非流式兩種方式',
              subTitle: '消息',
            },
            inputs: {
              inputParameters: [
                ...
                },
                {
                  ...
                  input: {
                    ...
                    value: {
                      ...
                      content: [
                        { label: '換行', value: '\n', isDefault: true },
                        { label: '製表符', value: '\t', isDefault: true },
                        { label: '句號', value: '。', isDefault: true },
                        { label: '逗號', value: '，', isDefault: true },
                        { label: '分號', value: '；', isDefault: true },
        ...
        },
        {
          ...
          data: {
            nodeMeta: {
              ...
              icon: 'icon-Condition.png',
              description:
                '連接多個下游分支，若設定的條件成立則僅運行對應的分支，若均不成立則只運行“否則”分支',
              subTitle: '選擇器',
            },
            inputs: {
              branches: [
        ...
        },
        {
          ...
          data: {
            nodeMeta: {
              title: '終止循環',
              icon: 'icon-Break.png',
              description: '用於立即終止當前所在的循環，跳出循環體',
              subTitle: '終止循環',
            },
          },
        },
