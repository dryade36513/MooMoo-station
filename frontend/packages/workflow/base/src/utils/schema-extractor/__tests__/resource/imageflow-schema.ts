        ...
        inputs: {
          apiParam: [
            ...
            },
            {
              ...
              input: {
                type: 'string',
                value: { type: 'literal', content: '文生圖' },
              },
            },
            {
              name: 'pluginVersion',
        ...
        inputs: {
          apiParam: [
            ...
            },
            {
              ...
              input: {
                type: 'string',
                value: { type: 'literal', content: '智能換臉' },
              },
            },
            {
              name: 'pluginVersion',
        ...
        inputs: {
          apiParam: [
            ...
            },
            {
              ...
              input: {
                type: 'string',
                value: { type: 'literal', content: '提示詞優化' },
              },
            },
            {
              name: 'pluginVersion',
