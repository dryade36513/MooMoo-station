...
describe('EditMenu 組件', () => {
  ...
  test('當visible爲true且configs不爲空時應渲染菜單', () => {
    render(
      <EditMenu
        configs={[EditMenuItem.EDIT, EditMenuItem.DELETE]}
        visible={true}
