...
describe('ColWidthCacheService', () => {
  ...
  describe('initWidthMap', () => {
    test('當 localStorage 中不存在緩存時應該初始化一個空 Map', () => {
    ...
    test('當 localStorage 中已存在緩存時不應該重新初始化', () => {
  ...
  describe('setWidthMap', () => {
    ...
    test('當緩存中已存在相同 tableKey 時應該更新緩存', () => {
      // Simulate localStorage.getItem to return an existing cache
      localStorageMock.getItem.mockReturnValueOnce('[["table1",{"col1":100}]]');
    ...
    test('當緩存中不存在相同 tableKey 且緩存未滿時應該添加新緩存', () => {
      // Simulate localStorage.getItem to return an existing cache
      localStorageMock.getItem.mockReturnValueOnce('[["table1",{"col1":100}]]');
    ...
    test('當緩存中不存在相同 tableKey 且緩存已滿時應該移除最舊的緩存並添加新緩存', () => {
    ...
    test('當 localStorage 操作拋出異常時應該拋出 CustomError', () => {
  ...
  describe('getTableWidthMap', () => {
    test('當緩存中存在 tableKey 時應該返回對應的緩存並更新其位置', () => {
      // Simulate localStorage.getItem to return an existing cache
      localStorageMock.getItem.mockReturnValueOnce(
        '[["table1",{"col1":100}],["table2",{"col1":200}]]',
      );
