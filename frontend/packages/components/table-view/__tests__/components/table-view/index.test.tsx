...
describe('TableView 組件', () => {
  ...
  test('當提供自定義空狀態時應顯示自定義空狀態', () => {
    const customEmpty = <div data-testid="custom-empty">自定義空狀態</div>;
  ...
  test('當滾動到底部時應調用scrollToBottom回調', () => {
    render(<TableView {...defaultProps} isVirtualized={true} />);
