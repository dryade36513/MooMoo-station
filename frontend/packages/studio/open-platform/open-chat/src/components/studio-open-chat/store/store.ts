...
export interface ChatState {
  ...
  /**
   * @description 用來表示被選中的當前會話 id 、上下文的 id 和是否顯示會話列表
   */
...
export interface ChatAction {
  ...
  /**
   * @description 這裏只是爲給發送消息那裏一個方法，用戶根據第一條 query 來更新會話名稱
   * @param currentConversationInfo 當配置了 isNeedConversationAdd 後的當前會話會話信息，包括會話列表是否展開
   */
