...
A centralized context management package that provides global state, event handling, and navigation utilities for MooMoo Station web applications. This package helps you avoid direct window object manipulation and provides a structured way to handle global application state.
