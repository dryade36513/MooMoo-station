...
export enum ModelType {
  ...
  SeedForMusic = 48,
  XiaoningWithMem = 49,
  /** 功能性bot的模型從100開始，舊版bot的模型在100以下  pangzhiqiang@bytedance.com */
  GPT_35Turbo = 100,
  GPT_35Turbo0301 = 101,
  GPT_4 = 102,
  GPT_40314 = 103,
  ...
  /** 虛假的 llm，function call 協議，一直調用第一個 function */
  Echo = 123,
  GPT_40613 = 124,
  /** for seed test */
...
export interface EngineInterruptInfo {
  /** 存儲少量信息，json數據，無需上游感知 */
  dataJson?: string;
  /** redis key, value爲json, see EngineInterruptPluginInfo */
  dataKey?: string;
}
...
export interface PreGenReq {
  /** 語音預搜索鏈路，給chat_engine發請求需要的信息 */
  type?: PreGenType;
  /** 標識一次未被用戶新Query覆蓋的對話，只能不變或遞增 */
  psession_id?: Int64;
  /** 預搜索階段生成的token數 */
...
export interface ResumeInfo {
  ...
  /** 上一次被打斷時engine側的部分信息，用以恢復engine側的狀態 */
  engine_interrupt_info?: EngineInterruptInfo;
  /** engine調插件被打斷後得到的信息，用以恢復plugin側的狀態 */
