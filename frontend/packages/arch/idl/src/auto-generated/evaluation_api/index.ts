...
export default class EvaluationApiService<T> {
   ...
   *
   * FornaxAppSearchObject FornaxApp SearchObject 透傳接口，端上發起請求後服務端轉發至 FornaxApp
   */
   ...
   *
   * 查詢namespace dataset id 下自動生成數據集的任務狀態
   */
   ...
   *
   * 從指定的row_group_id 開始刪除後面的所有row_group
   */
   ...
   *
   * ListDatasetV2 ListDataset爲Get接口,無法通過body傳遞tagID list進行篩選, 因此新增ListDatasetV2接口邏輯與ListDataset一致
   */
  ListDatasetV2(
   ...
   *
   * PullCaseV2 PullCase爲Get接口,無法通過body傳遞datasetIDs進行篩選, 因此新增PullCaseV2接口邏輯與PullCase一致
   */
  PullCaseV2(
