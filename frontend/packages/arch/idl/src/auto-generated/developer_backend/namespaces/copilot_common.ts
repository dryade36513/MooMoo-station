...
/** copilot 側上游可傳遞的 bot info. 對齊 bot 平臺 bot info 的部分字段. */
...
export interface FileParseInfo {
  /** 按用戶上傳的文件在前，GPT Engine解析出的URL在後，放在一個列表中 */
  file_info?: FileInfo;
...
/** 意圖識別包，reply_type=7 && content_type=300 時content的內容 */
...
/** 需要一個結構體，用於定義 message list 的額外屬性，如裁剪規則等 */
...
export interface ToolCallInfo {
  /** json字符串，可解析爲ocean_cloud_plugin.DoActionRequest。包含上一次調插件的完整信息 */
  api_input?: string;
  plugin_id?: Int64;
  api_name?: string;
  call_id?: string;
