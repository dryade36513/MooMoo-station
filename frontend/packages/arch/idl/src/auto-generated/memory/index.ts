...
export default class MemoryService<T> {
   ...
   *
   * Dataset - 遷移中: 請在 flow_dataengine_dataset.thrift 里加
   */
  CreateDataSet(
   ...
   *
   * 創建批量抓取任務  deprecated: 遷移中: 請在 flow_dataengine_dataset.thrift 里加
   */
   ...
   *
   * 「coze 2.0 新增數據庫節點的需求」新的獲取bot和database的對應關係
   */
  GetBotDatabase(
    req: table.GetBotTableRequest,
    options?: T,
