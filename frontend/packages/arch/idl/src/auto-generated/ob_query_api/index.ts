...
export default class ObQueryApiService<T> {
   ...
   *
   * 豆包&cici特化: 通過 logID/traceID/messageID 查詢 tracing 數據
   */
  QueryTrace(
   ...
   *
   * 豆包&cici特化: 通過 tag 關鍵字 查詢 tracing 數據
   */
  ListSpans(
   ...
   *
   * 通過 logID/traceID/messageID 查詢 tracing 數據
   */
  SearchTrace(
