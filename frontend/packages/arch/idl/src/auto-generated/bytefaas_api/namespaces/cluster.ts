...
export interface CreateClusterRequest {
  ...
  /** auth switch. 鑑權開關 */
  auth_enable?: boolean;
  /** cluster name, starts with faas-. 集羣名 */
  cluster: string;
  /** ID of code revision. 部署代碼版本 ID */
  code_revision_id?: string;
  /** number of code revision. 部署代碼版本號 */
  code_revision_number?: string;
  /** cold start switch. 冷啓動開關, true 爲關閉 */
  cold_start_disabled?: boolean;
  /** CORS switch. CORS 開關 */
  cors_enable?: boolean;
  /** Whether co-locate scheduling is enabled */
  ...
  /** region name */
  region: string;
  /** function reserved mode switch. 函數預留模式開關 */
  reserved_dp_enabled?: boolean;
  /** Revision ID for the cluster configuration */
  revision_id?: string;
  /** Revision number for the cluster configuration */
  revision_number?: number;
  /** function routing strategy, enums：prefer_reserved, prefer_elastic. 函數路由調度策略 */
  routing_strategy?: string;
  /** Whether auto-scaling is enabled */
  scale_enabled?: boolean;
...
export interface VefaasTrafficSchedulingTriggerData {
  /** 觸發器 ID，eventbus觸發器的ID爲EventName
