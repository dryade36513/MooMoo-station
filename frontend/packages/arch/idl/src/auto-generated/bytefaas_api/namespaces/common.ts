...
export interface TicketResourceMetaFunctionResourceMessage2FunctionMetaMessage2 {
  ...
  auth_enable?: boolean;
  /** Authorizers of function, split by ',', 函數的授權人，用 ',' 分隔 */
  authorizers?: string;
  /** Limit of cold start, 冷啓動超時參數 */
  cold_start_sec?: number;
  /** Enable cors，允許跨域 */
  cors_enable?: boolean;
  /** Description of function, 函數描述 */
  description?: string;
  /** Disable build install, true means disable. Only support python/nodejs, 是否調過構建，僅支持 python/nodejs */
  disable_build_install?: boolean;
  ...
  initializer?: string;
  /** Limit of function latency, 函數時延超時參數 */
  latency_sec?: number;
  /** Max concurrency for one function instance */
  max_concurrency?: number;
  /** Memory of function, used for set function resource, unit is MB */
  memory_mb?: number;
  /** Name of function, 函數名稱 */
  name?: string;
  /** Origin of function, from bytefaas ori light(like qingfuwu), 函數的來源，除了 faas 也有可能是來自輕服務等 */
  origin?: string;
  /** The owner of function, 函數的 Owner */
  owner?: string;
