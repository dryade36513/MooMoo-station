...
How the code revision is deployed. Enums: online-edit, scm, command-line, online-edit, image, lego */
  ...
  lazyload?: boolean;
  /** Code revision number, generated by server if empty. 版本號
Unique number for the code revision */
  ...
  /** Service ID */
  service_id: string;
  /** Source of code revision. 代碼版本 URI
URI for the code revision source */
  source: string;
  /** Source type of code revision. 代碼版本類型。Enums: url, tos, scm, ceph, image, image-scm, private-tos, lego */
  source_type: string;
