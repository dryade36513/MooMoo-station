...
export interface Comment {
  ...
  /** ProductEntityType 所屬商品的實體類型，當 ItemType = Product 時有對應的值：1-bot商品；2-插件商品；6-應用商品；21-bot模板；23-工作流模板；26-應用模板 */
