...
export default class UiBuilderService<T> {
   ...
   *
   * GetCustomComponentPackageResponse GetCustomComponentPackage(1: GetCustomComponentPackageRequest req)(agw.method = 'POST',   agw.uri = '/api/ui_builder/v1/component/package/list',  api.category="ui", agw.preserve_base="true")    // 獲取組件包組件內容
   *
   * 比較自定義組件
   */
