...
> Comprehensive internationalization (i18n) resource adapter for MooMoo Station applications

This package provides a centralized internationalization resource adapter containing localized strings and type definitions for MooMoo Station applications. It supports multiple languages and provides type-safe access to translation keys with parameter interpolation.
...
- 📝 **Extensive Coverage**: Over 13,000+ translation strings covering the entire MooMoo Station ecosystem

## Get Started

### Installation

This package is part of the MooMoo Station monorepo and should be installed via Rush:
...
This package is part of the MooMoo Station monorepo and follows the same licensing terms as the main project.
