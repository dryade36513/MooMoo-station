...
describe('space-gray', () => {
  ...
  describe('TccKey', () => {
    it('應該定義 ImageGenerateConverter 常量', () => {
  ...
  describe('useSpaceGrayStore', () => {
    ...
    describe('load', () => {
      it('應該調用 GetWorkflowGrayFeature API 並更新狀態', async () => {
        const { result } = renderHook(() => useSpaceGrayStore());
      ...
      it('當 IS_BOT_OP 爲 true 時應該調用 OPGetWorkflowGrayFeature API', async () => {
      ...
      it('當 spaceId 與緩存的相同時不應該調用 API', async () => {
        const { result } = renderHook(() => useSpaceGrayStore());
    ...
    describe('isHitSpaceGray', () => {
      it('當特性在灰度列表中且 in_gray 爲 true 時應該返回 true', async () => {
        const { result } = renderHook(() => useSpaceGrayStore());
      ...
      it('當特性在灰度列表中但 in_gray 爲 false 時應該返回 false', async () => {
      ...
      it('當特性不在灰度列表中時應該返回 false', async () => {
        const { result } = renderHook(() => useSpaceGrayStore());
