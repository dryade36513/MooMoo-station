...
describe('auth', () => {
  ...
  describe('useAuthStore', () => {
    ...
    describe('fetchCollaborators', () => {
      it('當資源類型爲 Bot 時應該調用 PlaygroundApi.DraftBotCollaboration', async () => {
        const { result } = renderHook(() => useAuthStore());
      ...
      it('當資源類型爲 Workflow 時應該調用 workflowApi.ListCollaborators', async () => {
        const { result } = renderHook(() => useAuthStore());
      ...
      it('當資源類型爲 Intelligence 時應該調用 intelligenceApi.ListCollaborators', async () => {
        const { result } = renderHook(() => useAuthStore());
    ...
    describe('addCollaborator', () => {
      it('當資源類型爲 Bot 時應該調用 patPermissionApi.AddCollaborator', async () => {
        const { result } = renderHook(() => useAuthStore());
      ...
      it('當資源類型爲 Workflow 時應該調用 workflowApi.AddWorkflowCollaborator', async () => {
        const { result } = renderHook(() => useAuthStore());
    ...
    describe('removeCollaborators', () => {
      it('當資源類型爲 Bot 時應該調用 patPermissionApi.RemoveCollaborator', async () => {
        const { result } = renderHook(() => useAuthStore());
    ...
    describe('batchRemoveCollaborators', () => {
      it('應該調用 patPermissionApi.RemoveCollaborator', async () => {
        const { result } = renderHook(() => useAuthStore());
    ...
    describe('batchAddCollaboratorsServer', () => {
      it('應該調用 patPermissionApi.BatchAddCollaborator', async () => {
        const { result } = renderHook(() => useAuthStore());
