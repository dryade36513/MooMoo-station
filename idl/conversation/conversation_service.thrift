...
service ConversationService {
    ...
    conversation.RetrieveConversationApiResponse RetrieveConversationApi(1: conversation.RetrieveConversationApiRequest request) (api.get = '/v1/conversation/retrieve', api.category = "conversation", api.tag="openapi", agw.preserve_base = "true") //查詢會話詳情
}
