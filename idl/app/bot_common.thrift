...
struct ModelInfo {
    ...
    11: optional CacheType          CacheType           (api.body="cache_type")                                   , // 緩存配置
    12: optional bool               SpCurrentTime       (api.body="sp_current_time")                                , // sp拼接當前時間
    13: optional bool               SpAntiLeak          (api.body="sp_anti_leak")                                   , // sp拼接防泄露指令
    14: optional bool               SpVoiceInfo         (api.body="sp_voice_info")                                  , // sp拼接聲紋信息
